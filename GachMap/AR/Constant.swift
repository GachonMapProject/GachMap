...
struct ArkitNodeDimension {
    ...
    static let sourceNodeLength = CGFloat(3.0)
    static let sourceNodeWidth = CGFloat(3.0)
    static let sourceNodeHeight = CGFloat(3.0)
    static let sourceChamferRadius = CGFloat(0.5)
